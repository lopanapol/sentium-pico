...
version 42
__lua__
-- crazy-cat-32x32-v3.p8

--[[
  A simple game about a cat that goes crazy for red dots.
  This version uses a 32x32 sprite, properly centered and
  constrained to the screen. V3 attempts to fix the "only eyes"
  bug by drawing the second cat from the spritesheet.
--]]
...
function _draw()
  ...
  -- The base index for the cat sprite. Trying '4' for the second cat.
  local cat_sprite_base = 4
...
function update_movement(pixel)
  ...
  if dist_to_target > 2 then
    ...
    -- Constrain center of 32x32 sprite to screen edges
